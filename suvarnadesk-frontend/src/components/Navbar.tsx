              ...
              <div className="p-6 bg-white border border-gray-200 shadow-2xl rounded-2xl">
                ...
                <div className="flex gap-3">
                  <motion.button
                    ...
                    className="flex-1 px-4 py-3 text-sm font-medium text-gray-700 transition-colors bg-gray-100 border border-gray-300 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
                  >
                    Cancel
                  </motion.button>
                  <motion.button
                    ...
                    className="flex-1 px-4 py-3 text-sm font-medium text-white transition-colors bg-red-600 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                  >
                    Yes, Logout
                  </motion.button>
                </div>
